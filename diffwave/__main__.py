...
if __name__ == '__main__':
  ...
  parser.add_argument('--model_dir',
      help='directory in which to store model checkpoints and training logs',default='/home/xlt/fy/diffwave-master/src/diffwave/model')
  parser.add_argument('--data_dirs', nargs='+',
      help='space separated list of directories from which to read .wav files for training',default='/home/xlt/fy/data/LJSpeech-1.1/test')
